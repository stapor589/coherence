...
export const CHAPTERS = [
    ...
    topics: [
      {
        ...
        concepts: [
          'Prędkość dźwięku c ≈ 331,3 + 0,606·T [m/s] (T w °C); przy 20°C ≈ 343 m/s',
          'Długość fali λ = c / f — 20 Hz ≈ 17 m, 1 kHz ≈ 34 cm, 20 kHz ≈ 17 mm',
          'Okres T = 1/f; przesunięcie fazy φ = 360° · f · Δt',
          'Pasmo 20 Hz–20 kHz to ~10 oktaw; tercje i ich znaczenie w analizie',
          'Stałe opóźnienie = faza rosnąca liniowo z częstotliwością',
          'Wpływ temperatury na czasy przelotu i wyrównanie systemów delay',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'dB jako stosunek: 10·log dla mocy, 20·log dla ciśnienia i napięcia',
          'dB SPL (ref. 20 µPa), dBu (ref. 0,775 V), dBV (ref. 1 V), dBFS',
          '+6 dB = 2× napięcie/ciśnienie, +3 dB = 2× moc, ~+10 dB ≈ subiektywnie 2× głośniej',
          'Wagi częstotliwościowe A, C, Z — do czego służy każda',
          'Leq, LAeq,15min, LCpeak — uśrednianie w czasie vs szczyt',
          'Wartość szczytowa, RMS i współczynnik szczytu (crest factor)',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'Sumowanie koherentne: dwa identyczne sygnały w fazie = +6 dB',
          'Sumowanie niekoherentne (nieskorelowane): dwa równe źródła = +3 dB',
          'Filtr grzebieniowy: pierwsze wycięcie f = 1/(2·Δt), kolejne co 1/Δt',
          'Izolacja poziomów: przy różnicy ≥ 10 dB ripple spada do ~+2,4/−3,3 dB',
          'Strefy sumowania, przejścia i izolacji (McCarthy)',
          'Nakładanie vs izolacja — kompromis między mocą a jednorodnością',
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        concepts: [
          'Kąt pokrycia definiowany w punktach −6 dB',
          'Beamwidth w funkcji częstotliwości',
          'Współczynnik kierunkowości Q i indeks DI = 10·log Q',
          'Tuby, falowody, stała kierunkowość (CD)',
          'Rozmiar źródła względem długości fali — dlaczego LF jest dookólne',
          'Dane balonowe (GLL, CLF) i ich wykorzystanie w predykcji',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'Prawo odwrotności kwadratów: −6 dB na podwojenie odległości',
          'Kąt rozwarcia (splay) równy kątowi pokrycia — minimalne nakładanie',
          'Nakładanie kątowe i przestrzenne — sumowanie vs jednorodność',
          'Stosunek odległości bliski/daleki (aspect ratio) a jednorodność poziomu',
          'Konfiguracje L/R, LCR, centralny klaster',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'Kryteria WST (Heil, Urban): wypełnienie powierzchni emitującej i odstęp źródeł',
          'Pole bliskie (−3 dB/podwojenie) vs daleki (−6 dB/podwojenie)',
          'Granica pola bliskiego rośnie z częstotliwością i kwadratem długości tablicy',
          'Krzywizna progresywna (J) vs stała (arc) — rozkład SPL front-back',
          'Długość tablicy a pionowa kontrola LF',
          'Site angle, trim height, masa i ograniczenia rigowe',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'Rozstaw subów w rzędzie < λ/2 najwyższej częstotliwości pracy, by uniknąć lobingu',
          'Power alley przy szeroko rozstawionych subach L/R',
          'Stack gradientowy/kardioidalny: element tylny z opóźnieniem i odwróconą polaryzacją',
          'End-fire: rzędy w osi, opóźnienie równe czasowi przelotu między rzędami',
          'Arc fizyczny i elektroniczny (delay-arc) — sterowanie szerokością',
          'Suby podwieszone vs naziemne — kompromisy wyrównania',
        ],
        quiz: [
    ...
    topics: [
      {
        ...
        concepts: [
          'Pozyskanie rysunków (DWG/PDF), wymiarów i punktów rigu',
          'Płaszczyzny słuchania: siedzący ~1,2 m, stojący ~1,6–1,7 m nad podłogą',
          'Ograniczenia: typowe programy (Soundvision, ArrayCalc, MAPP) liczą głównie dźwięk bezpośredni',
          'Kiedy potrzebna jest symulacja akustyczna (EASE, ray tracing)',
          'Poziom szczegółowości modelu vs czas pracy',
          'Walidacja predykcji pomiarem i dalmierzem na miejscu',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'Jednorodność poziomu w strefie publiczności (np. ±3 dB w pasmie)',
          'Jednorodność tonalna — spektrum podobne w całej strefie',
          'Docelowy SPL na FOH z odpowiednim zapasem (headroom)',
          'Energia na publiczność, nie na ściany i sufit',
          'STI jako miara zrozumiałości mowy; typowy cel ≥ 0,50',
          'Mapy w pasmach oktawowych zamiast jednej mapy szerokopasmowej',
        ],
        quiz: [
          { q: 'Typowy cel jednorodności poziomu w głównej strefie publiczności to:', a: ['±0,5 dB', '±3 dB', '±10 dB', 'Brak celu'], c: 1, e: 'Ok. ±3 dB to realny, często przyjmowany cel.' },
      ...
      },
      {
        ...
        concepts: [
          'Main L/R vs LCR vs mono — konsekwencje dla obrazu i pokrycia',
          'Front/lip fill: rozstaw zależny od odległości do pierwszego rzędu i kąta pokrycia',
          'Out fill / side hang — kiedy tablica główna nie sięga',
          'Delay: gdy spada poziom i stosunek bezpośredni/pogłos',
          'Przestrzenny punkt przejścia (spatial crossover) — równe poziomy',
          'Utrzymanie obrazu na scenie mimo wielu źródeł',
        ],
        quiz: [
      ...
      {
        id: 'rigging', title: 'Rigging, obciążenia i bezpieczeństwo', level: 'średni',
        summary: 'System engineer nie musi być riggerem, ale musi rozumieć obciążenia, kąty bridle i dokumentację, żeby projekt był wykonalny i bezpieczny.',
        concepts: [
          'WLL (dopuszczalne obciążenie robocze) i współczynnik bezpieczeństwa',
          'Masa całkowita: system + ramy + wyciągarki + kable',
          'Bridle: większy kąt między nogami = większa siła w każdej nodze',
          'Wyciągarki D8 vs D8+ (C1) i zasady pracy nad ludźmi',
          'Pullback, kąt site i przesunięcie środka ciężkości',
          'Wiatr w plenerze, procedury i dokumentacja producenta',
        ],
        quiz: [
          { q: 'WLL oznacza:', a: ['Obciążenie zrywające', 'Maksymalne dopuszczalne obciążenie robocze', 'Masę własną elementu', 'Siłę wiatru'], c: 1, e: 'Working Load Limit — nie wolno go przekraczać.' },
          { q: 'Gdy kąt między nogami bridle rośnie, siła w każdej nodze:', a: ['Maleje', 'Nie zmienia się', 'Rośnie', 'Spada do zera'], c: 2, e: 'Rośnie składowa pozioma, więc całkowita siła w nodze też.' },
          { q: 'Wyciągarka D8+ w odróżnieniu od D8:', a: ['Jest szybsza', 'Może utrzymywać ładunek nad ludźmi bez dodatkowego zabezpieczenia (w warunkach producenta i przepisów)', 'Ma większy udźwig', 'Nie wymaga inspekcji'], c: 1, e: 'D8+ ma m.in. podwójny hamulec; zawsze obowiązują lokalne przepisy i procedury.' },
        ],
        tasks: [
          'Dla swojego systemu policz masę całkowitą jednej strony (elementy, rama, kable, wyciągarki) i sprawdź w software producenta dopuszczalne kąty.',
        ],
    ...
    topics: [
      {
        ...
        concepts: [
          'Weryfikacja: polaryzacja, routing, uszkodzenia, poziomy — przed EQ',
          'Kolejność: element → tablica → subsystem → łączenie subsystemów',
          'Pozycje mikrofonów: ONAX, OFFAX, XOVER',
          'Main → sub → fills → delay — typowa sekwencja',
          'Kryteria zakończenia i dokumentacja (snapshoty, zrzuty ekranu)',
          'Zarządzanie czasem strojenia w realnym harmonogramie',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'Wybór częstotliwości i nachylenia zwrotnicy',
          'Faza w pasmie przejścia jako kryterium, nie sam pik IR',
          'Polaryzacja vs opóźnienie — kiedy które narzędzie',
          'Geometria: suby na ziemi i tablica w górze — różnica dróg zmienia się z pozycją',
          'Filtry all-pass jako narzędzie dopasowania nachylenia fazy',
          'Weryfikacja w wielu miejscach i kompromis',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'Poziom i EQ fillu w jego ONAX',
          'Czas w XOVER z systemem głównym',
          'Delay minimalnie po main — obraz zostaje na scenie',
          'Różnice w absorpcji HF: main z daleka vs delay z bliska',
          'Kontrola nakładania — łagodne przejścia między strefami',
        ],
        quiz: [
      ...
      },
      {
        ...
        concepts: [
          'Korygujemy przyczyny wspólne dla strefy, nie wycięcia interferencyjne',
          'Średnia przestrzenna z kilku pozycji',
          'Krzywe docelowe: podniesiony LF i łagodny spadek HF',
          'Array EQ / korekcje strefowe w procesorach producentów',
          'Weryfikacja uszami: znana muzyka referencyjna',
          'Wpływ publiczności i temperatury na odpowiedź',
        ],
        quiz: [
  ...
  {
    id: 'ch15', short: 'Projekt sal', title: 'Projektowanie pomieszczeń odsłuchowych i studyjnych', color: '#e0845f', icon: 'blueprint',
    subtitle: 'Proporcje, reżyserka, ustawienie głośników i akustyka zmienna.',
    topics: [
      {
        id: 'proporcje', title: 'Kubatura i proporcje pomieszczenia', level: 'zaawansowany',
        summary: 'O akustyce małego pomieszczenia decydują wymiary — zanim wniesiesz jakikolwiek ustrój. Dobre proporcje rozkładają mody równomiernie, złe tworzą problemy nie do naprawienia.',
        concepts: [
          'Bardzo małe pomieszczenia (poniżej ok. 40–50 m³) są podatne na zakolorowania: mało modów, duże odstępy między nimi',
          'Zalecane proporcje (np. Sepmeyera 1,00 : 1,28 : 1,54) rozkładają mody możliwie równomiernie',
          'Zawsze weryfikuj proporcje obliczeniem: lista modów osiowych, odstępy i koincydencje',
          'Sygnały ostrzegawcze: kilka modów w tej samej częstotliwości albo mod odizolowany o ponad ok. 25 Hz od sąsiadów',
          'Sześcian i wymiary będące wielokrotnościami to najgorszy możliwy wybór',
          'W istniejącym pomieszczeniu wymiarów nie zmienisz — pozostają ustroje, ustawienie i akceptacja ograniczeń',
        ],
        quiz: [
          { q: 'Dlaczego pomieszczenie o wymiarach 4 × 4 × 4 m jest akustycznie złym wyborem?', a: ['Za mała powierzchnia ścian', 'Wszystkie mody osiowe pokrywają się, dając silne zakolorowania', 'Za dużo modów', 'Za krótki czas pogłosu'], c: 1, e: 'Równe wymiary oznaczają potrójną koincydencję każdego modu osiowego.' },
          { q: 'Mod odizolowany o ponad 25 Hz od sąsiednich oznacza:', a: ['Idealny rozkład', 'Ryzyko słyszalnego zakolorowania w tej okolicy pasma', 'Brak basu', 'Błąd obliczeń'], c: 1, e: 'Duże luki w rozkładzie modów są równie problematyczne jak ich kumulacje.' },
          { q: 'Proporcje typu 1,00 : 1,28 : 1,54 służą do:', a: ['Wyznaczenia czasu pogłosu', 'Równomiernego rozłożenia drgań własnych', 'Obliczenia izolacyjności', 'Ustawienia głośników'], c: 1, e: 'To punkt wyjścia przy projektowaniu nowego pomieszczenia — i tak weryfikowany obliczeniem.' },
        ],
        tasks: [
          'Policz listę modów osiowych dla trzech wariantów wymiarów planowanego pomieszczenia i wybierz najlepszy rozkład. Udokumentuj odstępy i koincydencje.',
        ],
        res: ['b-everest', 'b-long', 't-rew'],
      },
      {
        id: 'rezyserka', title: 'Reżyserka: ITDG i strefa bez odbić', level: 'zaawansowany',
        summary: 'Na drodze od monitorów do uszu realizatora powinno panować „nic” — żadnych wczesnych odbić. Dopiero potem pomieszczenie może wrócić z rozproszoną energią.',
        concepts: [
          'ITDG — czas między dźwiękiem bezpośrednim a pierwszym istotnym odbiciem; w najlepiej ocenianych salach rzędu 20 ms',
          'Strefa pozbawiona odbić (RFZ): wokół pozycji odsłuchowej nie ma silnych wczesnych odbić',
          'Osiąga się to pochłanianiem, ale też odchyleniem powierzchni tak, by energia trafiała poza strefę',
          'Za strefą bez odbić stosuje się rozpraszanie, żeby pomieszczenie nie było martwe',
          'Symetria lewa–prawa jest warunkiem stabilnego obrazu stereofonicznego',
          'Konsoleta, ekrany i biurko tworzą własne odbicia — często silniejsze niż ściany',
        ],
        quiz: [
          { q: 'Strefa pozbawiona odbić (RFZ) oznacza, że:', a: ['Pomieszczenie jest bezechowe', 'W okolicy pozycji odsłuchowej brak silnych wczesnych odbić', 'Nie ma pogłosu', 'Monitory stoją w narożnikach'], c: 1, e: 'Późniejsza, rozproszona energia jest pożądana — chodzi o pierwsze odbicia.' },
          { q: 'ITDG to:', a: ['Czas pogłosu', 'Odstęp między dźwiękiem bezpośrednim a pierwszym istotnym odbiciem', 'Opóźnienie systemu', 'Miara izolacyjności'], c: 1, e: 'W najlepiej ocenianych salach koncertowych wynosi ok. 20 ms.' },
          { q: 'Najczęściej pomijane źródło wczesnych odbić w reżyserce to:', a: ['Sufit', 'Blat konsolety i ekrany monitorów', 'Podłoga za plecami', 'Drzwi'], c: 1, e: 'Odbicie od blatu dociera bardzo wcześnie i silnie barwi dźwięk.' },
        ],
        tasks: [
          'Zmierz ETC w pozycji odsłuchowej swojej reżyserki. Wyznacz ITDG i wskaż powierzchnie odpowiedzialne za trzy pierwsze odbicia.',
        ],
        res: ['b-everest', 'b-toole', 't-rew'],
      },
      {
        id: 'ustawienie', title: 'Ustawienie głośników i pozycji odsłuchowej', level: 'średni',
        summary: 'Zanim sięgniesz po EQ, przesuń głośnik i krzesło. Sprzężenie z powierzchniami i rozkład ciśnienia modów zmieniają bas bardziej niż jakakolwiek korekcja.',
        concepts: [
          'Bliskość jednej twardej powierzchni daje ok. +3 dB, dwóch (krawędź) ok. +6 dB, trzech (narożnik) ok. +9 dB w niskich częstotliwościach',
          'Gdy odległość od powierzchni jest porównywalna z λ, zamiast równego wzmocnienia pojawia się interferencja (wycięcia)',
          'Rozkład ciśnienia modu: pierwszy mod osiowy ma węzeł w środku pomieszczenia, drugi maksimum',
          'Pozycja odsłuchowa dokładnie w połowie długości to typowy sposób na utratę części basu',
          'Optymalizacja pozycji dotyczy głównie zakresu ok. 20–300 Hz; wyżej decydują odbicia i kierunkowość',
          'Zalecenia numeryczne trzeba weryfikować słuchem i pomiarem — najlepszy bas nie zawsze oznacza najlepszy obraz stereo',
        ],
        quiz: [
          { q: 'Głośnik wstawiony w narożnik (trzy powierzchnie) daje w niskich częstotliwościach około:', a: ['+3 dB', '+6 dB', '+9 dB', 'bez zmian'], c: 2, e: 'Energia promieniuje w 1/8 przestrzeni zamiast w pełnej sferze.' },
          { q: 'Dlaczego pozycja odsłuchowa w połowie długości pomieszczenia bywa zła?', a: ['Bo tam jest największy pogłos', 'Bo w węźle pierwszego modu osiowego brakuje energii w LF', 'Bo tam zbiegają się odbicia od sufitu', 'Bo jest za blisko monitorów'], c: 1, e: 'W węźle ciśnienie tego modu jest bliskie zeru — słyszysz dziurę w basie.' },
          { q: 'Optymalizacja ustawienia głośników i słuchacza dotyczy przede wszystkim pasma:', a: ['20–300 Hz', '300–2000 Hz', '2–8 kHz', 'całego pasma równomiernie'], c: 0, e: 'Powyżej tego zakresu o wyniku decydują odbicia i kierunkowość, nie mody.' },
        ],
        tasks: [
          'Zmierz odpowiedź w pasmie 20–300 Hz w trzech pozycjach odsłuchowych i dwóch ustawieniach monitorów. Wybierz kombinację z najmniejszym rozrzutem i opisz różnice.',
        ],
        res: ['b-toole', 'b-everest', 't-rew'],
      },
      {
        id: 'zmienna', title: 'Akustyka zmienna i pomieszczenia wielofunkcyjne', level: 'średni',
        summary: 'Jedno pomieszczenie, wiele zastosowań: od nagrania perkusji po lektora. Regulowane elementy pozwalają zmieniać charakter bez przebudowy.',
        concepts: [
          'Strefy o różnym charakterze: żywa dla instrumentów akustycznych, martwa dla lektora i bliskiego mikrofonowania',
          'Elementy obrotowe i panele na zawiasach: z jednej strony pochłanianie, z drugiej odbicie lub rozpraszanie',
          'Przenośne moduły (pułapki narożne, parawany) jako szybka zmiana warunków',
          'Zasłony i kotary jako regulowane pochłanianie średnio-wysokotonowe',
          'Cel: powtarzalność — zapisz i opisz konfiguracje, które sprawdziły się przy konkretnych nagraniach',
          'W pomieszczeniach AV i kabinach lektorskich priorytetem jest brak zakolorowań i niskie tło, nie długi pogłos',
        ],
        quiz: [
          { q: 'Regulowane panele w studiu pozwalają przede wszystkim:', a: ['Zmienić kubaturę', 'Zmieniać proporcję pochłaniania do rozpraszania', 'Poprawić izolacyjność', 'Obniżyć tło akustyczne'], c: 1, e: 'To sposób na dopasowanie charakteru pomieszczenia do nagrywanego materiału.' },
          { q: 'Kabina lektorska powinna być przede wszystkim:', a: ['Bardzo pogłosowa', 'Pozbawiona zakolorowań i cicha', 'Duża', 'Symetryczna względem monitorów'], c: 1, e: 'Małe pomieszczenie łatwo barwi głos — liczy się neutralność i tło.' },
          { q: 'Zasłony i kotary działają głównie jako pochłanianie:', a: ['Niskotonowe', 'Średnio- i wysokotonowe', 'Szerokopasmowe', 'Rezonansowe'], c: 1, e: 'Bez dużej masy i odstępu nie kontrolują basu.' },
        ],
        tasks: [
          'Przygotuj dwie konfiguracje swojego pomieszczenia (żywa i martwa), zmierz RT w pasmach dla obu i opisz, do jakiego materiału pasują.',
        ],
        res: ['b-everest', 'b-long'],
      },
    ],
  },
];
